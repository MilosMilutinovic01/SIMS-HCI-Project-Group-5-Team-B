...
{
    public class TourRequestLocationStatistics : INotifyPropertyChanged
    {
        private int year;
        public int Year
        {
        ...
        public TourRequestLocationStatistics(int year, Location location, int numberOfAcceptedRequests, int numberOfRejectedRequests)
        {
            Year = year;
            Location = location;
