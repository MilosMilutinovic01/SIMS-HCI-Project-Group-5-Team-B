...
{
    public class SingleReservationViewModel : INotifyPropertyChanged
    {
        ...
        public SingleReservationViewModel(Reservation reservation, bool isForGrading, bool isModifiable, bool isCancelable)
        {
